    ...
    Row(
      ...
      children: [
        Align(
          ...
          child: InkWell(
            onTap: () {
              launch("https://www.facebook.com/augustine.francis.5?mibextid=LQQJ4d");
            },
            child: CircleAvatar(
              radius: 16,
              backgroundColor: primary,
              child: Icon(FontAwesomeIcons.facebook, size: 20),
            ),
          ),
        ),
        const SizedBox(
        ...
        Align(
          ...
          child: InkWell(
            onTap: () {
              launch("https://instagram.com/augustinebfrancis?igshid=MzRlODBiNWFlZA==");
            },
            child: CircleAvatar(
              radius: 16,
              backgroundColor: primary,
