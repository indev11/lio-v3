...
class V3yoga extends StatefulWidget {
  const V3yoga({Key? key}) : super(key: key);

  @override
  State<V3yoga> createState() => _V3yogaState();
}

class _V3yogaState extends State<V3yoga> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset("images/yoga3.mp4")..initialize().then((_) {
      // Ensure the first frame is shown after the video is initialized,
      // even before the play button has been pressed.
      setState(() {});
    });
